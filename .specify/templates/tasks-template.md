...
- [ ] T003 [P] Configure formatting, linting, and strict typechecking tools
...
> **NOTE: Add the narrowest executable checks required by the constitution before or alongside implementation.**
...
- [ ] TXXX [P] Additional unit tests needed to protect shared logic in tests/unit/
...
- Required validation tasks MUST run before a story is considered complete
...
- Verify required validation passes before closing a task group
