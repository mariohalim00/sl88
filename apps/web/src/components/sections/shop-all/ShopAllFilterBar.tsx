...
const quickFilters = ["Kitchen", "Welcome Mats", "Outdoor", "Wool", "Silk", "Jute"];

export function ShopAllFilterBar({ searchTerm, totalItems, onSearchChange }: ShopAllFilterBarProps) {
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-[1fr_auto_auto]">
        ...
        <div className="relative">
          ...
          <span className="pointer-events-none absolute top-1/2 right-3 -translate-y-1/2 text-[#504533]">▾</span>
        </div>
      </div>
    </div>
  );
