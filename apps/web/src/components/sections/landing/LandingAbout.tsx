    ...
    >
      ...
      <div className="space-y-5 text-center md:text-left">
        ...
        <p className="text-base leading-relaxed text-[#504533] md:text-lg">
          Based in {companyInfo.headquarters.city}, our master artisans preserve
          traditional weaving methods with ethically sourced materials. Every
          knot reflects patience, precision, and enduring beauty.
        </p>
      </div>
    </section>
  );
