    ...
    <div className="space-y-12 md:space-y-20">
      <section className="grid items-center gap-8 md:min-h-170grid-cols-2 md:gap-12">
        <div className="space-y-5 text-center md:text-left">
          ...
          <p className="mx-auto max-w-xl text-base leading-relaxed text-[#504533] md:mx-0 md:text-lg">
            Experience handcrafted carpets that blend timeless tradition with contemporary calm.
            Each piece is designed to transform daily spaces into warm, tactile galleries.
          </p>
      ...
      <section id="collection" className="space-y-8 md:space-y-10">
        <div className="space-y-2 text-center">
          <h2 className="font-heading text-3xl font-semibold text-[#1c1c15] md:text-4xl">Curated Collections</h2>
          ...
          {categoryHighlights.map((item, index) => (
            ...
            >
              ...
              <div className="absolute right-0 bottom-0 left-0 p-6 text-white md:p-8">
                ...
                <p className="mt-1 text-sm text-white/85 md:text-base">{item.description}</p>
              </div>
            </article>
          ))}
        </div>
      ...
      <section id="contact-us" className="border-t border-[#d4c4ac] py-12 md:py-16">
          ...
          <div className="order-last space-y-6 md:order-first md:space-y-8">
            ...
            <form className="space-y-4 md:space-y-6">
              <div className="space-y-1">
                <label className="block text-xs font-semibold uppercase tracking-wide text-[#504533]" htmlFor="name">
                  Full Name
                </label>
                <input
                  id="name"
              ...
              <div className="space-y-1">
                <label className="block text-xs font-semibold uppercase tracking-wide text-[#504533]" htmlFor="email">
                  Email Address
                </label>
                <input
                  id="email"
              ...
              <div className="space-y-1">
                <label className="block text-xs font-semibold uppercase tracking-wide text-[#504533]" htmlFor="message">
                  Inquiry
                </label>
                <textarea
                  id="message"
