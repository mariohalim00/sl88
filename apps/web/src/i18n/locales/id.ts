export const id = {
  ...
  landing: {
    ...
    about: {
      ...
      title: 'Tentang Kami',
      description:
        'Berbasis di {{city}}, para artisan kami menjaga metode tenun tradisional dengan bahan yang bersumber etis. Setiap simpul mencerminkan kesabaran, presisi, dan keindahan yang bertahan lama.',
    },
    contact: {
      title: 'Kunjungi Toko!',
      description:
  ...
  productGrid: {
    ...
    noMatchesDescription: 'Coba cari berdasarkan jenis ruangan, gaya, atau material.',
  },
  productDetails: {
